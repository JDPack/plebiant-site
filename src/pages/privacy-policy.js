...
<br /><br />
            <p style={{fontSize: 24}}><span className="section-heading font-weight-bold">
              TABLE OF CONTENTS
            </span></p>

            <p><a href="#privacy-collect"><span>1. WHAT INFORMATION DO WE COLLECT?</span></a>
            ...
            <br /><a href="#privacy-controls"><span>9. CONTROLS FOR DO-NOT-TRACK FEATURES </span></a>
            <br /><a href="#privacy-ca"><span>10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS? </span></a>
            <br /><a href="#privacy-updates"><span>11. DO WE MAKE UPDATES TO THIS POLICY?</span></a>
            <br /><a href="#privacy-contact"><span>12. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</span></a></p>

            <p id="privacy-collect" style={{fontSize: 24}}><span className="section-heading font-weight-bold">
              1. WHAT INFORMATION DO WE COLLECT?
            </span></p>

            <p><strong>Information collected through our Games and Apps</strong>
<br /><strong><em>In Short:</em></strong> <em>We may collect information regarding your mobile device, push notifications, when you use our apps.
If you use our Apps, we may also collect the following information:</em></p>

<br /><p><em>Mobile Device Access.</em> We may request access or permission to certain features from your mobile device, including your mobile device’s bluetooth, camera, contacts, microphone, storage, social media accounts, sensors, and other features. If you wish to change our access or permissions, you may do so in your device’s settings.</p>

<br /><p><em>Push Notifications.</em> We may request to send you push notifications regarding your account or the mobile application. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings.</p>


            <br /><p id="privacy-use" style={{fontSize: 24}}><span className="section-heading font-weight-bold">
            2. HOW DO WE USE YOUR INFORMATION?  
            </span></p>

            <p><strong><em>In Short:</em></strong> <em>We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent. </em> 
            <br />We use personal information collected via our Services or Apps for a variety of business purposes described below. We process your personal information for these purposes in reliance on our legitimate business interests, in order to enter into or perform a contract with you, with your consent, and/or for compliance with our legal obligations. We indicate the specific processing grounds we rely on next to each purpose listed below. 
            </p>
            ...
            <br /><p id="privacy-share" style={{fontSize: 24}}><span className="section-heading font-weight-bold">
